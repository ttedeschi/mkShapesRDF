...
def runAnalysis(samples, aliases, variables, preselections, cuts, lumi, outputFileMap='single'):
    ...
    def analyse(samples, sampleName, filesType):
        ...
        for var in list(variables.keys()):
            if variables[var]['name'] != '1':
                if variables[var]['name'] not in list(df2.GetColumnNames()):
...
if __name__ == '__main__':
    ...
    runAnalysis(samples, aliases, variables, preselections, cuts, lumi)
