...
aliases["fakeW"] = {"expr": "fakeW2l_ele_" + eleWP + "_mu_" + muWP, "samples": ["Fake"]}
...
aliases["zeroJet"] = {"expr": "Alt(CleanJet_pt, 0, 0) < 30."}

aliases["oneJet"] = {"expr": "Alt(CleanJet_pt, 0, 0) > 30."}

aliases["multiJet"] = {"expr": "Alt(CleanJet_pt, 1, 0) > 30."}
...
for shift in [
    ...
    for targ in ["bVeto", "bReq"]:
        ...
        alias["expr"] = alias["expr"].replace(
            "btagSF_deepcsv_shape", "btagSF_deepcsv_shape_up_%s" % shift
        )
        ...
        alias["expr"] = alias["expr"].replace(
            "btagSF_deepcsv_shape", "btagSF_deepcsv_shape_down_%s" % shift
        )
...
# variations
aliases["SFweightEleUp"] = {"expr": "LepSF2l__ele_" + eleWP + "__Up", "samples": mc_emb}
aliases["SFweightEleDown"] = {
    "expr": "LepSF2l__ele_" + eleWP + "__Do",
    "samples": mc_emb,
}

aliases["SFweightMuUp"] = {"expr": "LepSF2l__mu_" + muWP + "__Up", "samples": mc_emb}
aliases["SFweightMuDown"] = {"expr": "LepSF2l__mu_" + muWP + "__Do", "samples": mc_emb}
