...
class LeptonSF(Module):
    ...
    def runModule(self, df, values):
        ...
        ROOT.gInterpreter.Declare(f'auto csetEl = correction::CorrectionSet::from_file("{self.pathToJson}");')
        ROOT.gInterpreter.Declare('auto csetEl_2018preID = csetEl->at("UL-Electron-ID-SF");')
